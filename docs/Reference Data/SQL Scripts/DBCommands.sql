...
SELECT id, Accountid, Messageid, Staffid FROM AccountMessages;
...
INSERT INTO AccountMessages(id, Accountid, Messageid, Staffid) VALUES (?, ?, ?, ?);
...
UPDATE AccountMessages SET Accountid = ?, Messageid = ?, Staffid = ? WHERE id = ?;
