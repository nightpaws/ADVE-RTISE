...
-- UPDATE STATEMENTS
UPDATE Account
SET website = ?, username = ?, password = ?, year = ?, enabled = ?
WHERE id = ?;
UPDATE AccountMessages
SET Accountid = ?, Messageid = ?
WHERE id = ?;
UPDATE Class
SET code = ?, description = ?, year = ?
WHERE id = ?;
UPDATE ClassStaff
SET Staffid = ?, Classid = ?
WHERE id = ?;
...
WHERE id = ?;
UPDATE Message
SET subject = ?, message = ?, `date` = ?
WHERE id = ?;
UPDATE Staff
SET forename = ?, surname = ?, username = ?, mail = ?, active = ?
WHERE id = ?;
UPDATE Student
SET forename = ?, surname = ?, username = ?, regnum = ?, mail = ?, active = ?, subscribed = ?
WHERE id = ?;

-- DELETE STATEMENTS
DELETE FROM Account
WHERE id = ?;
DELETE FROM AccountMessages
WHERE id = ?;
DELETE FROM Class
WHERE id = ?;
DELETE FROM ClassStaff
WHERE id = ?;
